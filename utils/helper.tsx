...
export const buttonClass = (id: TBtnState): IBtnCls => {
  switch (id) {
    case 'init':
      return { btn: '', span1: 'text-red-600 border-blue-600', span2: 'text-gray-600', alpha: null };
    case 'correct':
      return { btn: 'bg-green-500', span1: 'text-white border-white', span2: 'text-white', alpha: '✔' };
    case 'incorrect':
      return { btn: 'bg-red-600', span1: 'text-white border-white', span2: 'text-white', alpha: 'X' };
  }
};
